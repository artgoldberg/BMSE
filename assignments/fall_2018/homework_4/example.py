...
plt.yticks([0,0.25,0.5], ["0","+0.35","+0.7"], color="grey", size=7)
plt.ylim(-0.3,0.7)
...
for ix,row in df.iterrows():
    ...
    labeled = True
adjust_text(labels,arrowprops=dict(arrowstyle='->', color='red'),save_steps=False)

fig = plt.gcf()
fig.savefig("polar.png")
print("Figure saved to /workfiles/polar.png.")